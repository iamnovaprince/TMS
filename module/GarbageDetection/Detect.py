...
model = tf.keras.models.load_model('module\\GarbageDetection\\model\\garbage_detection.h5')
garbage_haar_cascade = cv2.CascadeClassifier('module\\GarbageDetection\\model\\garbage_cascade.xml')
label_dict = {0 : 'Garbage', 1: 'Glass', 2: 'Mask', 3: 'Metal', 4: 'Non Garbage', 5: 'Organic', 6: 'Plastic'}

def GarbageDetector(frame):
